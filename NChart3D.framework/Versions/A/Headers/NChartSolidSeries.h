 ...
 */
@interface NChartSolidSeries : NChartSeries
 ...
 */
@interface NChartSolidSeriesSettings : NChartSeriesSettings

/**
 * Fill ratio for series that determines the amount of places for one series. For example, of the fill ratio is 1.0 and
