 ...
 */
@interface NChartBezierInterpolator : NChartInterpolator

/**
 * Create the bezier iterpolator with given control point.
 *
 * @param controlPoint - control point. Very oftern it makes sense when the control point is equal to the end value of
 * animated property.
